...
<html lang="en">
  <head>
    ...
    <title>Hospital Management System (HMS): Login</title>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">                                
                                <div class="row-fluid user-row">
                                    <h3>Hospital Management Syatem</h3>
                                    <p style="font-size: 14px;font-weight: bold;text-align:center;"> By : <a href="http://ruhulamin.cf/">Md.Ruhul Amin</a></p>
                                </div>
                            </div>
