									...
									<h1>Patient Registration</h1>
										...
										<div class="row clearfix">
											...
											<div class="col-md-5 column">
												...
												?>
												<?php echo form_open('registration/oldview',$attributes); ?>
													<div class="form-group">
														<label class="col-md-6">Patient ID:</label>
...
<!--Registered Patient Modal-->
		<div class="container">
			<div class="modal fade" id="reg-preview">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						 <div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h1><small>Patient Summary</small></h1>
							<h2><b>Patient ID:</b>&nbsp;125634</h2>
						 ...
						 <div class="modal-body">
							...
							<div class="col-md-8">
								<table class="table table-bordered">
									...
									<tr>
										<td><b>Remarks</b></td>
										<td>Sensitive to Sulpha</td>
									</tr>
								</table>
								<a href=""><button type="submit" class="btn btn-success">Register</button></a>
							</div>
							</div>
